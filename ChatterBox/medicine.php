...
function ()
{
$('#chatbox').load('medicineupdate.php').fadeIn('slow');
...
include('dbh.php');
$query="SELECT * FROM medicine order by date desc";
...
<form method="POST" action="send.php">
 <div class="row send" style="">
      ...
      <input class="btn btn-outline-success my-2 my-sm-0" type="submit" name='submitmed' value="Send Message"></input>
 </div>
</form>
