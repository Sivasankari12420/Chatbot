...
if(isset($_POST['add'])){
    ...
    $query1="INSERT INTO $title VALUES('0','$teammember','',NOW())";
...
$query="SELECT * FROM $title order by date desc";
$result=mysqli_query($dbc,$query);
while($row=mysqli_fetch_array($result)){
  $username=$row['name'];
...
<form method="POST" action="send.php">
 <div class="row send" style="">
      ...
      <input class="btn btn-outline-success my-2 my-sm-0" type="submit" name='submit' value="Send Message"></input>
 </div>
</form>
